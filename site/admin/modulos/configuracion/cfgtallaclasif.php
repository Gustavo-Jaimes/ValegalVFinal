...
echo '
	<div class="uk-width-1-1 margin-top-20 uk-text-left">
		<ul class="uk-breadcrumb uk-text-capitalize">
			...
			<li><a href="index.php?rand='.rand(1,1000).'&modulo='.$modulo.'&archivo=cfgtallaclasif" class="color-red">Tipos de fecha</a></li>
		</ul>
	</div>
		...
		<div class="uk-container uk-container-small">
			<div class="uk-card uk-card-default uk-card-body uk-border-rounded">
				...
				<div class="uk-text-right uk-margin">
					<a href="#add" uk-toggle class="uk-button uk-button-success"><i uk-icon="plus"></i> &nbsp; Nuevo tipo de fecha</a>
				</div>
				...
				<form action="index.php" method="post">
					...
					<div uk-grid class="uk-grid-collapse">
						<div class="uk-width-1-1">
							<input type="text" name="txt" class="uk-input" placeholder="Nuevo tipo de fecha" required><br><br>
						</div>
