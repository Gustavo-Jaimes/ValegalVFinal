...
// BREADCRUMB
	...
	<div class="uk-width-auto margin-top-20 uk-text-left">
		<ul class="uk-breadcrumb uk-text-capitalize">
			...
			<li><a href="index.php?rand='.rand(1,1000).'&modulo='.$modulo.'&archivo=cfgtallaclasif">Tipos de fecha</a></li>
		...
		<div class="uk-width-1-1 margin-v-20">
			<div class="uk-container uk-container-xsmall">
				...
				<div class="uk-margin uk-text-right">
					<a href="#add" uk-toggle class="uk-button uk-button-success"><i uk-icon="plus"></i> &nbsp; Nueva fecha</a>
				</div>
	
				<table class="uk-table uk-table-striped uk-table-hover uk-table-small uk-table-middle uk-table-responsive">
					<thead>
						<tr>
							<th width="auto">FECHAS</th>
					...
					while ($rowCONSULTA = $CONSULTA -> fetch_assoc()) {
						...
						$fechainicio=$rowCONSULTA['fechainicio'];
						$fechafinal=$rowCONSULTA['fechafinal'];
						$nombrefecha=$rowCONSULTA['txt'];
						...
						<tr id="'.$thisID.'">
							...
							<td class="uk-text-nowrap">
								<a class="editarfecha" href="#modalfecha" data-id="'.$thisID.'" data-nombre="'.$nombrefecha.'" data-inicio="'.$fechainicio.'" data-final="'.$fechafinal.'" uk-toggle><i class="fas fa-pen" style="font-size:18px;color:red; padding-right: .5em"></i></a>
...
<!--editar -->
	<div id="modalfecha" uk-modal>
		<div class="uk-modal-dialog uk-modal-body">
			<h4>EDITAR FECHA</h4>
			
			<label for="start">Nombre Fecha:</label>
			<input class="editarajax" data-tabla="productostalla" data-campo="txt" data-id=" " type="txt" id="nom" name="txt"><br>

			<label for="start">Fecha inicio:</label>
			<input class="editarajax" data-tabla="productostalla" data-campo="fechainicio" data-id=" " type="date" id="ini" name="fechainicio"
			
			min="2021-01-01" max="2025-12-31">

			<label for="start">Fecha Final:</label>
			<input class="editarajax" data-tabla="productostalla" data-campo="fechafinal" data-id=" " type="date" id="fin" name="fechafinal"
...
<script>
	$( ".editarfecha" ).click(function() {
	  let fechaini = $(this).attr('data-inicio');
	  let fechafin = $(this).attr('data-final');
	  let nombrefech = $(this).attr('data-nombre');
