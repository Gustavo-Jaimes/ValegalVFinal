	...
	<div class="uk-width-1-1 margin-top-20">
		...
		while ($rowConsulta = $consulta -> fetch_assoc()) {
			...
			if (strlen($rowConsulta['video'])>0) {
				...
				$file=$id.'.jpg';
				echo '
					<a href="javascript:borrarfoto(\''.$imagen.'\',\''.$id.'\')" class="uk-icon-button uk-button-danger" uk-icon="trash"></a>
					<br><br>
					<a href="'.$rutaSlider.$rowConsulta['imagen'].'" target="_blank">
						<img src="'.$rutaSlider.$imagen.'" class="img-responsive uk-border-rounded margen-bottom-20">
					</a>';
			}
			echo '
				</div>
