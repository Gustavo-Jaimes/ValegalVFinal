...
<div class="uk-width-1-1">
	<div class="uk-container uk-container-small">
		...
		<form action="index.php" method="post">
			...
			<div class="uk-margin">
				<label for="pregunta_en">Question</label>
				<input type="text" class="uk-input" name="pregunta_en" value="'.$row_catalogo['pregunta_en'].'" autofocus>
			</div>
			<div class="uk-margin">
			...
			<div class="uk-margin">
				<label for="respuesta_en">Answer</label>
				<textarea class="editor" name="respuesta_en">'.$row_catalogo['respuesta_en'].'</textarea>
			</div>
