<?php
$proyectos = $CONEXION -> query("SELECT * FROM proyectos WHERE id = $id");
$row_catalogo = $proyectos -> fetch_assoc();

echo '
<div class="uk-width-auto@m margin-top-20">
	<ul class="uk-breadcrumb uk-text-capitalize">
		<li><a href="index.php?rand='.rand(1,1000).'&modulo='.$modulo.'">PROYECTOS</a></li>
		<li><a href="index.php?rand='.rand(1,1000).'&modulo='.$modulo.'&archivo='.$archivo.'&id='.$id.'" class="color-red">Editar proyecto</a></li>
	</ul>
</div>
...
<div class="uk-width-1-1">
	<div class="uk-container uk-container-small">
		<div class="padding-v-20 uk-text-right">
			<a href="index.php?rand='.rand(1,99999).'&modulo='.$modulo.'&archivo=proyectosnuevo" id="add-button"></a>
		</div>
		<form action="index.php" method="post">
			...
			<div class="uk-margin">
				...
				<textarea class="editor" name="resultado">'.$row_catalogo['resultado'].'</textarea>
			</div>
			<div class="uk-margin">
				<label for="resultado_en">Outcome</label>
				<textarea class="editor" name="resultado_en">'.$row_catalogo['resultado_en'].'</textarea>
			</div>
