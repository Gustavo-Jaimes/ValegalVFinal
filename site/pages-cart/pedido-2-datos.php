...
<div class="uk-container margin-top-50 pt-8">
  ...
  //cambiar esta seccion por la parte comentada para habilitar la tienda
 /* echo '
  <div class="uk-width-1-1 uk-text-center padding-v-50">
      <div uk-grid class="uk-child-width-1-1@s">
        <div class=" uk-text-center">
          <a href="#spinner" uk-toggle data-enlace="procesar-deposito" class="siguiente uk-button uk-button-personal">Guardar cotizacion</a>
        </div>
      </div>
  </div>';*/
  echo '
