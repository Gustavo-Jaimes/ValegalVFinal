...
switch ($estatus) {
  ...
  case 4: 
    ...
    $CONSULTA15 = $CONEXION -> query("SELECT * FROM configuracion");
    $row_CONSULTA15= $CONSULTA15-> fetch_assoc();
    $banco = $row_CONSULTA15['bank'];
    ...
    $pagarButton='
            ...
            <div class="uk-card uk-card-default">
              <div class="uk-card-body">
                <div class="uk-width-1-1">
                  <p>
                    <b>Tu compra fue registrada correctamente. Por favor procede a pagar.</b><br>
                    <b>Datos Bancarios: '.$banco.'</b>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="uk-width-1-1 uk-text-center text-lg">
            Puedes revisar los detalles de tu compra en el<br>
  ...
  <div uk-grid>
    <div class="uk-width-1-1 margin-top-20">
      <div class="uk-alert uk-alert-<?=$estatusClase?> uk-text-center" data-uk-alert>
        ...
        Su compra se encuentra en estado: <b><?=$estatusMensaje?></b>
      </div>
    </div>
