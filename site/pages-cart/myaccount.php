...
<div class="uk-container pt-8">
	<div class="uk-card uk-card-default uk-card-body">
		<div class="uk-grid-match" uk-grid>
			<div class="uk-width-1-3 uk-flex uk-flex-center">
				<div style="max-width:200px;">
					<div>
						<?php
						$profileRuta= 'img/contenido/profile/';
						$profilePic = (strlen($row_USER['imagen'])>0 AND file_exists($profileRuta.$row_USER['imagen']))?$profileRuta.$row_USER['imagen']:$profileRuta.'default.jpg';
						echo '
