...
<div class="uk-container pt-8">
    ...
    <form method="post">
            ...
            <tbody>';
              ...
              if(isset($_SESSION['carro'])){
                foreach ($arreglo as $key) {
                  ...
                  // Fotos
                  $CONSULTA1 = $CONEXION -> query("SELECT * FROM productospic WHERE producto = $prodId LIMIT 1");
                  $numPics=$CONSULTA1->num_rows;
                  if ($numPics>0) {
                    $rowCONSULTA1 = $CONSULTA1 -> fetch_assoc();
                    $pic='img/contenido/productos/'.$rowCONSULTA1['imagen'];
                  ...
                  <tr>
                    ...
                    <td>
                    <a class="a-modal" href="#modal-img" data-img="'.$picHtml.'" uk-toggle>
      ...
      <div class="uk-width-1-1 uk-text-center margin-v-20">
        <div uk-grid class="uk-flex-center">
          <div>
            <a href="servicios#boq" class=" uk-button uk-button-large uk-button-default"><i uk-icon="icon:arrow-left;ratio:1.5;"></i> &nbsp; Seguir comprando</a>
          </div>
          <div>
  ...
  '<div id="modal-img" class="uk-flex-top" uk-modal>
    <div class="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
        ...
        <img  id="img-Mod" src="" alt="" style="max-height: 21em;">
    </div>
</div>
';
  ?>
